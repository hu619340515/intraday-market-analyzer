...
输出：报告保存到 `memory/market_analysis_YYYYMMDD_HHMM.md`
...
```bash
# 9:00 券商晨报（配合broker-report-crawler使用）
# 9:25 盘前市场分析
0 9 * * 1-5 python3 ~/.openclaw/workspace/skills/intraday-market-analyzer/scripts/market_analyzer.py
